...
SECRET_KEY = "django-insecure-3zqd)u#*iei7m(jz7qil5k!nxz93tr$m%342i(h&r^gq*$07gy"
...
# External API Configuration (will be set when deployed)
EXTERNAL_API_URL = "http://localhost:8001/api/data/"  # Local fallback
